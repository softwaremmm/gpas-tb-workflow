...
workflow {
    main:
        ...
        // wp4
        competitive_mapping(kraken_reads_ch)
        filtered_reads_ch = competitive_mapping.out.reads_ch
        competitive_mapping.out.competitivemapping_report_json.first().copyTo("${outdir}/competitivemapping_report.json")
        competitive_mapping.out.competitivemapping_error_json.first().copyTo("${outdir}/competitivemapping_error.json")
        competitive_mapping.out.lc_error_json.first().copyTo("${outdir}/lc_error.json")
        competitive_mapping.out.mykrobe_report_json.first().copyTo("${outdir}/mykrobe_report.json")
        ...
        // WP6
        gnomonicus_workflow(vcf_ch)
        gnomonicus_workflow.out.gnomonicus_json.first().copyTo("${outdir}/tb/gnomonicus.json")
