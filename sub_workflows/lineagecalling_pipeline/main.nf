...
process mykrobe {
  cpus 5
  memory '6 GB'
  container 'lhr.ocir.io/lrbvkel2wjot/gpas/lineagecalling_container:v3.0.0'

  debug true
  pod label: "name", value: "lineagecalling_pipeline:mykrobe"
...
process mykrobe_json {
    ...
    debug true
    pod label: "name", value: "lineagecalling_pipeline:mykrobe_json"
    pod label: "sample_id", value: "${params.sample_id}"
    pod label: "run_id", value: "${params.run_id}"
