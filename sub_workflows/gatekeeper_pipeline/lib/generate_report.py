        ...
        for line in lines:
            ...
            for key in kraken2_keys:
                if index_key == str(key):
                    # Number of reads is multiplied by 2 as kraken2 outputs paried
                    # reads and the rest of the pipeline uses total reads
                    output_dict[key] = int(row[kraken_reads_count_column]) * 2
                    break
